...
y0=A*square(2*pi*F1*t,50);%方波
%方波
figure(2)
subplot(211)
plot(t,y0);                       
title('10KHz的半占空比的方波输入信号时域图');                    
xlabel('t/s');
ylabel('幅值/V');%输入时域图
